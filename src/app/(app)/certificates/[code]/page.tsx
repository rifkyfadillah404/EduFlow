...
export default async function CertificatePage({ params }: { params: Promise<{ code: string }> }) {
  ...
  return (
    <div className="container mx-auto p-4 py-12 flex flex-col items-center">
      <div className="w-full max-w-4xl aspect-[1.414] border-2 border-[var(--border-color)] bg-[var(--surface-secondary)] p-2 md:p-8 flex flex-col relative overflow-hidden certificate-container">
        ...
        <div className="flex-1 border-2 border-[var(--ink-dimmer)] p-6 md:p-12 flex flex-col justify-between text-center relative z-10">
          ...
          <div className="flex justify-between items-end pb-8">
            ...
            <div className="w-24 h-24 border-4 border-[var(--accent)] flex items-center justify-center relative">
              <div className="absolute inset-2 border border-[var(--accent)]"></div>
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--accent)]/5 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-48 h-48 bg-[var(--accent-orange)]/5 pointer-events-none"></div>
      </div>
